var testObj = {
    ...
    nameTest: function() {
        ...
        this.elemDivWrapper.appendChild(this.elemH1);
    },
    ...
    form: function(){
        ...
        this.elemDivWrapper.appendChild(this.elemForm);
    },
    ...
    QuesAndAnswers: function(){
        ...
        for ( var i = 0, questions = 3, countQ = 1, elemLi=[]; i < questions; i++, countQ++){
            ...
            elemLi[i].innerHTML = '<strong>' + 'Вопрос_' +  countQ + '</strong>'+ '</br>';
            ...
            this.elemOl.appendChild(elemLi[i]);
                ...
                for ( var j = 0, answers = 3, countA = 1, elemInput=[], elemLabel=[], elemDiv=[]; j < answers; j++, countA++){
                    ...
                    elemDiv[j].classList.add('checkbox');
                    ...
                    elemLabel[j].innerHTML = 'Вариант ответа_' + countA;
                     
                    
                    elemInput[j].classList.add('input');
                    elemInput[j].setAttribute('type','checkbox');
    ...
    button_submit: function(){
        this.elemButtonSubmit.classList.add('button_submit');
        this.elemButtonSubmit.classList.add('btn');
        this.elemButtonSubmit.classList.add('btn-success');
        this.elemButtonSubmit.setAttribute('type','submit');
